...
\begin{definition}
  ...
  $\mathcal{\mathcal{M}}$ y $\gamma$ una curva centrada en $p$. Diremos que $\mathcal{S}$ es un \define{transporte paralelo}{transporte-paralelo} a lo
  largo de $\gamma$ si
  \begin{equation}
    \nabla(\mathcal{S})
  \end{equation}

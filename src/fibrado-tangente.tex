...
\begin{definition}
  Sea $\mathcal{M}$ una variedad, se llama \define{fibrado tangente}{fibrado-tangente} al conjunto $\bigcup_{p\in M}\{p\}\times T_pM$.
  Se llama \define{fibrado cotangente}{fibrado-cotangente} al conjunto $\bigcup_{p\in M}\{p\}\times T^*_pM$.
\end{definition}
\begin{notation}
  Se escribe \glossarydef{fibrado-tangente}{$TM$}{fibrado tangente de M} al fibrado tangente de $\mathcal{M}$.
  Se escribe \glossarydef{fibrado-dual}{$T^* M$}{fibrado dual de M} al fibrado dual de $\mathcal{M}$.
\end{notation}
...
\begin{exercise}
  Demostrar que $T^* M$ es un $n$-fibrado tangente de $\mathcal{M}$.
\end{exercise}

\begin{definition}
  Sea $(E,\pi)$ un $s$-fibrado vectorial sobre la variedad $\mathcal{M}$, se llama \define{sección de M en
  E}{sección-fibrado-tangente} a la
  aplicación $\maps{\mathcal{S}}{M}{E}\ \mid\ \pi\circ\mathcal{S}=\operatorname{Id}$.
\end{definition}
\begin{notation}
  Se escribe $\Gamma(M,E)$ al conjunto de todas las secciones de $\mathcal{M}$ en $E$.
\end{notation}

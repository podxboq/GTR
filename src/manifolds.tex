...
\begin{definition}
  Se llama \define{campo de vectores}{campo-vectores} en $\mathcal{M}$ a una sección de $\mathcal{M}$ en $TM$.
  Se llama \define{campo de covectores}{campo-covectores} en $\mathcal{M}$ a una sección de $\mathcal{M}$ en $T^* M$.
\end{definition}

Sea $\{e^\alpha\}$ una base del espacio vectorial $V$
y $\{e_\alpha\}\subset V^*$\glossarydef{dual}{$V^*$}{Espacio dual de $V$} en el espacio dual las aplicaciones lineales, $e_\alpha: V
\longrightarrow
K$
actuando
sobre la
